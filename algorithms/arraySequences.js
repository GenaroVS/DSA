/**
 * @param {array} arr
 * @param {number} k Sequence length
 * @param {number} idx current sequence index
 * @param {number} n arr length
 * @return {void} Next seqence of k length
 */
...
/**
 * Find all sequences of unique positions in an array
 * O(Nk^2) Time, N being number of sequences
 * O(k) Space
 * @param {array} arr
 * @param {number} k Sequence length
 * @return {array}
